...
@Component(
        ...
        property = {
                ...
                SLING_SERVLET_RESOURCE_TYPES + "=" + "/apps/Elegant/dropdowns"
        }
)
...
public class DynamicDropdownServlet extends SlingSafeMethodsServlet {
    ...
    private Resource getJsonResource(ResourceResolver resourceResolver, String dropdownSelector) {
        ...
        switch (dropdownSelector) {
            case "countryList":
                jsonResource = resourceResolver.getResource("/content/dam/Elegant/country.json");
                break;
            case "colorList":
                jsonResource = resourceResolver.getResource("/content/dam/Elegant/color.json");
                break;
            case "fontList":
                jsonResource = resourceResolver.getResource("/content/dam/Elegant/font.json");
                break;
            default:
